import Vue from 'vue';
import template from './ogre.html';
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      shiftStart: 40,    // 0 for Run, 88 for Idle, 110 for jump
      frameWidth: 40,   // CONST
      ...
      sprite: {
        ogre: document.createElement('img'),
  ...
  mounted: function() {
    ...
    var canvas = document.getElementById('ogre');
    this.context.ogre = canvas.getContext('2d');
  ...
  methods: {
    loadSprites() {
      this.sprite.ogre.src = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/795933/ogreSheet.png';
